...
let colors = [ "Red","Gold","GhostWhite","Fuchsia","DeepSkyBlue"]
let initializeCount = 0
let maximumInitialize = 1

let initDelay = 1500// ms
let fireworkRadius = 1.5
...
let update = () => {
    canvasContext.fillStyle = "rgba(0,0,0,0.1)" // this will give tail effect
